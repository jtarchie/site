...
I have not written this yet, still working on it.

- exploration of write interface
- converting the extension to C for wider support
...
and the power of combining different technologies to solve problems.
